def question2_1():
    answer = ['Discrete', 'Ratio', 'It is discrete because the number of courses is countable and finite. It is Ratio because Its a count with a true zero (zero courses).']
    return answer
...
def question2_5():
    answer = ['Discrete', 'Nominal', 'Discrete because a finite set of distinct numbers. Nominal because its used for identification, not for quantitative measurement.']
    return answer
